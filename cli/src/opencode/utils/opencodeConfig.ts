 ...
 * for the agentchat change_title tool.
 */
...
const INSTRUCTIONS_FILENAME = 'agentchat-instructions.md';
 ...
 * @param mcpServer - The agentchat MCP server command configuration
