...
const PLUGIN_FILENAME = 'agentchat-hook.ts';
...
function buildPluginSource(hookUrl: string, token: string): string {
    ...
    return [
        '// Generated by AgentChat. Do not edit manually.',
        '',
        `const DEFAULT_HOOK_URL = ${escapedUrl};`,
        `const DEFAULT_HOOK_TOKEN = ${escapedToken};`,
        'const HOOK_URL = process.env.AGENTCHAT_OPENCODE_HOOK_URL || DEFAULT_HOOK_URL;',
        'const HOOK_TOKEN = process.env.AGENTCHAT_OPENCODE_HOOK_TOKEN || DEFAULT_HOOK_TOKEN;',
        '',
        ...
        "                'x-agentchat-hook-token': HOOK_TOKEN",
        '            },',
        '            body',
        '        });',
        '    } catch {',
