...
const DEFAULT_OUTBOX_MAX_BYTES = resolveEnvNumber('AGENTCHAT_OUTBOX_MAX_BYTES', 16_000_000)
const DEFAULT_OUTBOX_MAX_ITEMS = resolveEnvNumber('AGENTCHAT_OUTBOX_MAX_ITEMS', 500)
const DEFAULT_OUTBOX_MAX_ITEM_BYTES = resolveEnvNumber('AGENTCHAT_OUTBOX_MAX_ITEM_BYTES', 1_000_000)
const DEFAULT_OUTBOX_MAX_AGE_MS = resolveEnvNumber('AGENTCHAT_OUTBOX_MAX_AGE_MS', 15 * 60_000, true)
const DEFAULT_DROP_LOG_INTERVAL_MS = resolveEnvNumber('AGENTCHAT_OUTBOX_DROP_LOG_INTERVAL_MS', 5_000)
