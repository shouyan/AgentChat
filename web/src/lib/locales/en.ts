export default {
  ...
  'login.server.description': 'Set the AgentChat hub origin for API and live updates.',
  'login.server.current': 'Current:',
  'login.server.origin': 'Hub origin',
  'login.server.placeholder': 'https://agentchat.example.com',
  ...
  'newSession.browse.button': 'Browse',
  'newSession.browse.title': 'Choose directory',
  'newSession.browse.description': 'Browse folders on the selected machine, or keep typing a path manually.',
  'newSession.browse.home': 'Home',
  'newSession.browse.up': 'Up',
  'newSession.browse.current': 'Current directory',
  'newSession.browse.loading': 'Loading directories…',
  'newSession.browse.empty': 'No subdirectories here.',
  'newSession.browse.select': 'Select',
  'newSession.browse.useCurrent': 'Use current directory',
  ...
  // Install prompt
  'install.title': 'Install AgentChat',
  'install.description': 'Add AgentChat to your home screen for quick access.',
