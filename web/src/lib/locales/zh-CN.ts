export default {
  ...
  'login.server.description': '设置 AgentChat Hub 地址以使用 API 和实时更新。',
  ...
  'newSession.browse.button': '浏览',
  'newSession.browse.title': '选择目录',
  'newSession.browse.description': '浏览所选机器上的文件夹；也可以继续手动输入路径。',
  'newSession.browse.home': 'Home',
  'newSession.browse.up': '上级',
  'newSession.browse.current': '当前目录',
  'newSession.browse.loading': '正在加载目录…',
  'newSession.browse.empty': '这里没有子目录。',
  'newSession.browse.select': '选择',
  'newSession.browse.useCurrent': '使用当前目录',
  ...
  // Install prompt
  'install.title': '安装 AgentChat',
  'install.description': '将 AgentChat 添加到主屏幕以便快速访问。',
  'install.button': '安装',
