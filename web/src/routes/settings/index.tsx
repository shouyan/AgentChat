                ...
                <div className="mx-auto w-full max-w-content">
                    <div className="border-b border-[var(--app-divider)]">
                        ...
                        <div className="px-3 py-3">
                            <div className="rounded-lg border border-[var(--app-border)] bg-[var(--app-bg)] p-3">
                                <div className="text-sm font-medium">Current namespace</div>
                                <div className="mt-2 font-mono text-sm text-[var(--app-fg)]">{namespace}</div>
                                <div className="mt-2 text-xs text-[var(--app-hint)]">
                                    Templates, rooms, sessions, machines, and notifications are isolated per namespace.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-b border-[var(--app-divider)]">
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-between px-3 py-3 text-left transition-colors hover:bg-[var(--app-subtle-bg)]"
                        >
                            <span className="text-[var(--app-fg)]">Machines & providers</span>
                            <span className="text-[var(--app-hint)]">Open</span>
                        </button>
                    </div>
                    ...
                    <div className="border-b border-[var(--app-divider)]">
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-between px-3 py-3 text-left transition-colors hover:bg-[var(--app-subtle-bg)]"
                        >
                            <span className="text-[var(--app-fg)]">Manage room & role templates</span>
                            <span className="text-[var(--app-hint)]">Open</span>
                        </button>
                    </div>
